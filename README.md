...
- **Interactive Terminal**: A fully functional CLI. Try typing `help`, `ls`, or `open projects` to navigate the site.
- **Windowing System**: Apps open in draggable, focusable windows, allowing you to multitask just like a real desktop.
- **Command Palette**: Hit `Ctrl + K` to quickly search and jump to different sections of the site.
...
- **State Management**: [Zustand](https://zustand-demo.pmnd.rs/) (for the OS kernel state)
...
```bash
# Clone the repo
git clone https://github.com/DietherFernandez/portfolio.git
